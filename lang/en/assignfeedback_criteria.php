...
/**
 * Strings for component 'assignfeedback_criteria', language 'en'.
 *
...
$string['enabled'] = 'criteria feedback';
...
$string['pluginname'] = 'Criteria feedback';
...
$string['privacy:path'] = 'criteria feedback';
$string['criteria:manageowncriteriasets'] = 'Manage own saved criteria sets';
$string['criteria:publishcriteriasets'] = 'Make saved criteria sets available to other users';
$string['criteriafilename'] = 'criteria.html';
