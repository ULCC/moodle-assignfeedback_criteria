...
criteria feedback assignment subplugin for Moodle
===================================================

The criteria feedback assignment subplugin enables teachers to define
...
$ git clone https://github.com/lucisgit/moodle-assignfeedback_criteria.git criteria
$ cd criteria/
$ git checkout -b MOODLE_35_STABLE origin/MOODLE_35_STABLE
$ git branch -d master
$ cd /path/to/your/moodle/
$ echo /mod/assign/feedback/criteria/ >> .git/info/exclude


Installing from a zip archive downloaded from
https://moodle.org/plugins/pluginversions.php?plugin=assignfeedback_criteria:

1. Download and unzip the appropriate release for your version of
   Moodle.
2. Copy the extracted "criteria" folder into your
...
If you installed Moodle and the criteria feedback plugin from Git you
can run the following commands to update both (see
http://docs.moodle.org/35/en/Git_for_Administrators#Installing_a_contributed_extension_from_its_Git_repository):

$ cd /path/to/your/moodle/
$ git pull
$ cd mod/assign/feedback/criteria/
$ git pull
